     ...
     <div className="rounded-sm border min-h-screen bg-white items-center flex justify-center  ">
           ...
           <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <h2 className="mb-9 text-2xl font-bold text-black sm:text-title-xl2">
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none d"
                    />
                ...
                <div className="mb-5" onClick={handleNavigate}>
