      ...
      },
      {
        icon: (
          ...
          >
            <path
              fill="currentColor"
              d="M9 4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h6c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2H9zm0 2h6v12H9V6zm-4 6H3v6h2v-6zm16 0h-2v6h2v-6z"
            />
          </svg>
        ),
        label: "Room Types",
      ...
      },
      {
        icon: (
          <svg
            ...
            fill="currentColor"
          >
            <path d="M12 2c-1.1 0-2 .9-2 2v1H7.5c-.66 0-1.2.42-1.41 1.01L3.35 12l2.73 6.99c.21.59.75 1.01 1.41 1.01H20c1.1 0 2-.9 2-2v-4c0-1.1-.9-2-2-2h-1V9c0-1.1-.9-2-2-2h-3V4c0-1.1-.9-2-2-2zm0 5h5v2h-5V7zm-1 4.5c-.83 0-1.5.67-1.5 1.5S10.17 14.5 11 14.5s1.5-.67 1.5-1.5S11.83 11.5 11 11.5zM7 14.5c-.83 0-1.5.67-1.5 1.5S6.17 17.5 7 17.5 8.5 16.83 8.5 16 7.83 14.5 7 14.5zM15.5 14c-.83 0-1.5.67-1.5 1.5S14.67 17 15.5 17 17 16.33 17 15.5 16.33 14 15.5 14z" />
          </svg>
        ),
        label: "Offers",
        route: "/offer",
      ...
      },
      {
        icon: (
          <svg
            ...
            fill="currentColor"
          >
            <path d="M12 8a4 4 0 1 0 0 8 4 4 0 1 0 0-8zm8.94 2.06l-1.32-.18a6.99 6.99 0 0 0-1.1-2.66l.8-1.16a1 1 0 0 0-.12-1.28l-1.42-1.42a1 1 0 0 0-1.28-.12l-1.16.8a6.99 6.99 0 0 0-2.66-1.1l-.18-1.32A1 1 0 0 0 12 2h-2a1 1 0 0 0-1 .94l-.18 1.32a6.99 6.99 0 0 0-2.66 1.1l-1.16-.8a1 1 0 0 0-1.28.12L2.94 5.94a1 1 0 0 0-.12 1.28l.8 1.16a6.99 6.99 0 0 0-1.1 2.66l-1.32.18A1 1 0 0 0 2 12v2c0 .53.41.95.94 1l1.32.18a6.99 6.99 0 0 0 1.1 2.66l-.8 1.16a1 1 0 0 0 .12 1.28l1.42 1.42a1 1 0 0 0 1.28.12l1.16-.8a6.99 6.99 0 0 0 2.66 1.1l.18 1.32c.05.53.47.94 1 .94h2c.53 0 .95-.41 1-.94l.18-1.32a6.99 6.99 0 0 0 2.66-1.1l1.16.8a1 1 0 0 0 1.28-.12l1.42-1.42a1 1 0 0 0 .12-1.28l-.8-1.16a6.99 6.99 0 0 0 1.1-2.66l1.32-.18c.53-.05.94-.47.94-1v-2c0-.53-.41-.95-.94-1zM12 15a3 3 0 1 1 0-6 3 3 0 0 1 0 6z" />
          </svg>
        ),
        label: "Services",
        route: "/service",
