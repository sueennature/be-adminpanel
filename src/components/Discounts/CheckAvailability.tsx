          ...
          <div className="p-6.5">
            {!showBooking && (
              <div className="mb-6.5 flex flex-col gap-6 xl:flex-row">
                ...
                <button
                  ...
                  className="relative top-8 h-12 w-full justify-center rounded bg-primary p-3 font-medium text-gray hover:bg-opacity-90 xl:w-1/5"
                >
                  Check Availability
                </button>
              </div>
            ...
            {showBooking && (
              <BookingRoom
                ...
                room_type_view={selectedRoomView}
              />
            )}
          </div>
        </div>
